...
This project is indexed by GitNexus as **SecurePayload** (2387 symbols, 6435 relationships, 197 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
